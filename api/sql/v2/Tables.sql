...
DROP TABLE IF EXISTS `PostEntity`;
...
CREATE TABLE `Tag` (
	...
	CreatedByEntityID INT NOT NULL,
		FOREIGN KEY (CreatedByEntityID) REFERENCES `Entity`(EntityID),
	CreatedDateTimeUTC DATETIME(3) NOT NULL DEFAULT (UTC_TIMESTAMP())
);

CREATE TABLE `AssetTag` (
	AssetTagID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	AssetID INT NOT NULL,
		FOREIGN KEY (AssetID) REFERENCES `Asset`(AssetID),
	TagID INT NOT NULL,
		FOREIGN KEY (TagID) REFERENCES `Tag`(TagID),	
	TaggedByEntityID INT NOT NULL,
		FOREIGN KEY (TaggedByEntityID) REFERENCES `Entity`(EntityID)
);
...
CREATE TABLE `PostEntity` (
	PostEntityID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	PostID INT NOT NULL,
		FOREIGN KEY (PostID) REFERENCES `Post`(PostID),
	EntityID INT NOT NULL,
		FOREIGN KEY (EntityID) REFERENCES `Entity`(EntityID),
...
CREATE TABLE `Session` (
    ...
    Detail JSON NOT NULL,
	CreatedDateTimeUTC DATETIME(3) NOT NULL DEFAULT (UTC_TIMESTAMP()),
	ExpirationDateTimeUTC DATETIME(3) NOT NULL,
    UUID VARCHAR(255) UNIQUE NOT NULL DEFAULT (UUID())
);